...
export default function Login() {
  ...
  // when connected, push to "/"
  useEffect(() => {
    if (wagmiStatus === "connected" && !initialized.current) {
      initialized.current = true;
      console.log("connected, pushing to /...");
      router.push("/web3Auth-circle");
    }
  }, [wagmiStatus]);
  ...
  return (
    <div className="loginContainer1">
      <div className="loginContainer2">
        <p className="loginTitle">Sign In to Access Your Smart Contract Wallet</p>
